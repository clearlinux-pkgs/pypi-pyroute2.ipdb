...
Version  : 0.6.7
Release  : 13
URL      : https://files.pythonhosted.org/packages/0b/cd/6bc464e9487754447ef72e91ae8a88c3b49c4a1a593b9fef87deed55b97a/pyroute2.ipdb-0.6.7.tar.gz
Source0  : https://files.pythonhosted.org/packages/0b/cd/6bc464e9487754447ef72e91ae8a88c3b49c4a1a593b9fef87deed55b97a/pyroute2.ipdb-0.6.7.tar.gz
...
%prep
%setup -q -n pyroute2.ipdb-0.6.7
cd %{_builddir}/pyroute2.ipdb-0.6.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645464551
...
cp %{_builddir}/pyroute2.ipdb-0.6.7/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.ipdb/cd9bad64b174708395f795bb92f7b4be7d996e8f
cp %{_builddir}/pyroute2.ipdb-0.6.7/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.ipdb/4cc77b90af91e615a64ae04893fdffa7939db84c
