...
Source0  : https://files.pythonhosted.org/packages/a5/31/d2df1257ca43d4b5d76ef26f5889a59accde6199c82c63f6505686e96f08/pyroute2.ipdb-0.6.9.tar.gz
...
%prep
%setup -q -n pyroute2.ipdb-0.6.9
cd %{_builddir}/pyroute2.ipdb-0.6.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647893759
...
cp %{_builddir}/pyroute2.ipdb-0.6.9/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.ipdb/cd9bad64b174708395f795bb92f7b4be7d996e8f
cp %{_builddir}/pyroute2.ipdb-0.6.9/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.ipdb/4cc77b90af91e615a64ae04893fdffa7939db84c
