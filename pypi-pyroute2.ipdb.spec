...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707134962
...
cp %{_builddir}/pyroute2.ipdb-%{version}/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.ipdb/cd9bad64b174708395f795bb92f7b4be7d996e8f || :
cp %{_builddir}/pyroute2.ipdb-%{version}/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.ipdb/4cc77b90af91e615a64ae04893fdffa7939db84c || :
