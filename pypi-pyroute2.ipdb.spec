...
Provides: pyroute2.ipdb
Provides: pyroute2.ipdb-python
Provides: pyroute2.ipdb-python3
...
%prep
%setup -q -n pyroute2.ipdb-0.6.5
cd %{_builddir}/pyroute2.ipdb-0.6.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641478729
...
cp %{_builddir}/pyroute2.ipdb-0.6.5/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.ipdb/cd9bad64b174708395f795bb92f7b4be7d996e8f
cp %{_builddir}/pyroute2.ipdb-0.6.5/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.ipdb/4cc77b90af91e615a64ae04893fdffa7939db84c
