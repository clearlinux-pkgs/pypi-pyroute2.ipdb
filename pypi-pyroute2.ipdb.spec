...
Version  : 0.6.8
Release  : 14
URL      : https://files.pythonhosted.org/packages/f9/42/2e35d0846e55321c2233a43a61c574419b17b69d97da4e79bd9ad65aefea/pyroute2.ipdb-0.6.8.tar.gz
Source0  : https://files.pythonhosted.org/packages/f9/42/2e35d0846e55321c2233a43a61c574419b17b69d97da4e79bd9ad65aefea/pyroute2.ipdb-0.6.8.tar.gz
...
%prep
%setup -q -n pyroute2.ipdb-0.6.8
cd %{_builddir}/pyroute2.ipdb-0.6.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647103560
...
cp %{_builddir}/pyroute2.ipdb-0.6.8/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.ipdb/cd9bad64b174708395f795bb92f7b4be7d996e8f
cp %{_builddir}/pyroute2.ipdb-0.6.8/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.ipdb/4cc77b90af91e615a64ae04893fdffa7939db84c
